...
Manual scripted tested was performed as a group on Version 1.0, following the test suite outlined in Appendix C. Shawn performed the tests while the rest of the group members instructed him on the detailed steps, recorded outcomes, and created issues to submit to the Defect Report.
